...
function player_init(event, player)
   ...
   config:set_tab_interface(protocol.tab_item_bag, interfaces.tab_item_bag)
   config:set_tab_interface(protocol.tab_clan_chat, interfaces.tab_clan_chat)
   config:set_tab_interface(protocol.tab_emotes, interfaces.tab_emotes)

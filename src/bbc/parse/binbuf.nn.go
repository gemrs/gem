...
// u?int(8|16|24|32|64)
{[]bool{false, false, false, false, false, false, false, false, true, false, true, true, true, true}, []func(rune) int{  // Transitions
func(r rune) int {
	switch(r) {
		case 49: return -1
		case 50: return -1
...
// \/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*\/
{[]bool{false, false, false, false, false, false, true, false, false, false}, []func(rune) int{  // Transitions
func(r rune) int {
	switch(r) {
		case 10: return -1
		case 13: return -1
